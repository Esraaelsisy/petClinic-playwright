...
test.describe("PUT /owners/{ownerId}/pets/{petId} Tests", () => {
  ...
  test("Edit a pet @happy @bug", async ({ apiContext, petSchema }) => {
    ...
    await test.step("PUT /owners/{ownerId}/pets/{petId} request", async () => {
      const response = await RequestUtils.putRequest(
        apiContext,
        EndPoints.PET_BY_PET_ID,
        pet,
        { ownerId, petId: pet.id }
      );
  ...
  test("Edit a pet without name - BAD REQUEST @bug", async ({
    apiContext,
    errorSchema,
  }) => {
    ...
    await test.step("PUT /owners/{ownerId}/pets/{petId} request with invalid data", async () => {
      ...
      await test.step("Validate the BAD REQUEST response", async () => {
        responseBody = await ResponseUtils.validateBadRequestResponse(
          response,
          400
        );
      });
      ...
      await test.step("Validate the error response body schema", async () => {
        await ResponseUtils.validateResponseBodyScehma(
          responseBody,
          errorSchema
        );
      });
  ...
  test("Edit a pet with empty body - SERVER ERROR", async ({
    apiContext,
    errorSchema,
  }) => {
    ...
    await test.step("PUT /owners/{ownerId}/pets/{petId} request with empty body", async () => {
      ...
      await test.step("Validate the SERVER ERROR response", async () => {
        responseBody = await ResponseUtils.validateInternalServerErrorResponse(
          response,
          500
        );
      });
  ...
  test("Edit a pet with empty ownerID - NOT FOUND", async ({
    apiContext,
    errorSchema,
  }) => {
    ...
    await test.step("PUT /owners/{ownerId}/pets/{petId} request with empty ownerID", async () => {
      ...
      await test.step("Validate the NOT FOUND response", async () => {
        responseBody = await ResponseUtils.validateNotFoundResponse(
          response,
          400
        );
      });
  ...
  test("Edit a pet with empty petID - Method Not Allowed", async ({
    apiContext,
    errorSchema,
  }) => {
    ...
    await test.step("PUT /owners/{ownerId}/pets/{petId} request with empty petID", async () => {
      ...
      await test.step("Validate the Method Not Allowed response", async () => {
        responseBody = await ResponseUtils.validateMethodNotAllowedResponse(
          response,
          405
        );
      });
  ...
  test("Edit a pet with NOT FOUND ownerID - NOT FOUND @bug", async ({
    apiContext,
    errorSchema,
  }) => {
  ...
  test("Edit a pet with NOT FOUND petID - NOT FOUND @bug", async ({
    apiContext,
    errorSchema,
  }) => {
