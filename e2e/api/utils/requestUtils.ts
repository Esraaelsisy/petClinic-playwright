...
export class RequestUtils {
   ...
   */
  private static buildURL(endpoint: string, pathParams: Record<string, string> = {}): string {
   ...
   */
  public static async getRequest(apiContext: APIRequestContext, endpoint: string, pathParams: Record<string, string> = {}): Promise<APIResponse> {
    const resolvedEndpoint = this.buildURL(endpoint, pathParams);  // Using resolvePathParams here
   ...
   */
  public static async postRequest(apiContext: APIRequestContext, endpoint: string, requestBody: Record<string, any>, pathParams: Record<string, string> = {}): Promise<APIResponse> {
    const resolvedEndpoint = this.buildURL(endpoint, pathParams);  // Resolve path parameters in the endpoint URL
   ...
   */
  public static async putRequest(apiContext: APIRequestContext, endpoint: string, requestBody: Record<string, any>, pathParams: Record<string, string> = {}): Promise<APIResponse> {
    const resolvedEndpoint = this.buildURL(endpoint, pathParams);  // Resolve path parameters in the endpoint URL
   ...
   */
  public static async deleteRequest(apiContext: APIRequestContext, endpoint: string, pathParams: Record<string, string> = {}): Promise<APIResponse> {
    const resolvedEndpoint = this.buildURL(endpoint, pathParams);  // Resolve path parameters in the endpoint URL
   ...
   */
  public static logRequest(method: string, url: string, headers: Record<string, string>, body?: Record<string, any>) {
